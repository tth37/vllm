#!/bin/bash
# Benchmark: DockerBE with full SHM (both broadcast + response MQs)
# Runs configs 2, 5, 6 for comparison with previous hybrid SHM/TCP results
...
RESULTS_DIR="$SCRIPT_DIR/dockerbe_full_shm"
GPU_DEVICES="0,1"
